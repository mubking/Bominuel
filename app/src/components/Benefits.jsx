        ...
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div className="w-full md:w-1/2">
            ...
            <div className="flex items-start gap-4 mb-5 p-4 border bg-[#FEFEFE] border-gray-200">
              ...
              <div>
                <h4 className="font-semibold text-[#4F4F4F] text-[20px] mb-1">Real ingredients. Real flavour</h4>
            ...
            <div className="flex items-start gap-4 mb-5 p-4 border bg-[#FEFEFE] border-gray-200">
              ...
              <div>
                <h4 className="font-semibold text-gray-900 text-[20px] mb-1">Roots without walls</h4>
                <p className="text-gray-500 text-[16px] leading-relaxed">
          ...
          <div className="w-full md:w-1/2 relative h-[600px]">
            ...
            {/* Top-left: bottles row — left 65%, top 60% height */}
            ...
            {/* Bottom-right: bottle splash — right 65%, bottom 65% height, overlaps */}
            <div className="absolute bottom-0 right-[-20px] w-[60%] h-[85%] z-10">
              <Image
                src="/benefit-bottom.png"
                alt="BomiNuel bottle splash"
                fill
                className="object-cover object-center"
                sizes="(max-width: 768px) 100vw, 35vw"
              />
            ...
            {/* Hibiscus — top right */}
         {/* Hibiscus — bottom right, behind bottle */}
<div className="absolute top-[-75]  right-[-10px] z-0 pointer-events-none">
