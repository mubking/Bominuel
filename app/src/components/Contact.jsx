      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-8 mb-16">
          ...
          <div className="w-full lg:w-1/2">
            <div className="bg-white border h-[770px] w-full border-gray-200 rounded-sm p-8 flex flex-col">
          ...
          {/* Product Image */}
     {/* Product Image */}
<div className="w-full lg:w-1/2 relative min-h-[400px] lg:min-h-[770px] rounded-sm overflow-hidden">
  <Image
    src="/contacts.png"
  ...
  />
        ...
        <div className="flex flex-col lg:flex-row gap-0 items-stretch">
          ...
          <div className="w-full lg:w-1/2 relative min-h-[400px] lg:min-h-[738px]">
            <Image
              src="/Frame 5.png"
          ...
          <div className="w-full lg:w-1/2 bg-[#F9F8F2] px-6 md:px-10 py-12 flex flex-col justify-center">
            ...
            <div className="flex flex-col gap-4">
              {/* Phone */}
              <div className="flex items-center gap-4 border border-gray-200 bg-white rounded-sm px-4 py-3">
